...
def seed_cart_items():
    demoCart = Cart_Item(product_id=1, user_id=3, quantity=1)
    marnieCart = Cart_Item(product_id=3, user_id=1, quantity=5)
    bobbieCart = Cart_Item(product_id=5, user_id=2, quantity=1)
